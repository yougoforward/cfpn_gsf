...
class cfpn_gsf4Head(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer, se_loss, jpu=False, up_kwargs=None,
        ...
        self.se = nn.Sequential(
                            ...
                            nn.Sigmoid())
        self.gff = PAM_Module(in_dim=6*inter_channels, key_dim=6*inter_channels//8,value_dim=6*inter_channels,out_dim=6*inter_channels,norm_layer=norm_layer)
    ...
    def forward(self, c1,c2,c3,c4):
        ...
        out = torch.cat([p2_1,p2_8,p3_1,p3_8,p4_1,p4_8], dim=1)
        out = self.gff(out)
