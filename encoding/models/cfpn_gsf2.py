...
class cfpn_gsf2Head(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer, se_loss, jpu=False, up_kwargs=None,
        ...
        self.large_kernel = nn.Sequential(nn.Conv2d(in_channels, inter_channels, 3, padding=1, dilation=1, bias=False),
                                   norm_layer(inter_channels),
                                   nn.ReLU(),
    ...
    def forward(self, c1,c2,c3,c4):
        ...
        p4_0 = F.interpolate(self.large_kernel(c4), (h,w), **self._up_kwargs)
        ...
        out = self.project(torch.cat([p2_1,p2_8,p3_1,p3_8,p4_1,p4_8,p4_0], dim=1))
